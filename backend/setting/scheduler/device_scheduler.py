...
from devices.views import send_cpu_ram_to_local_elastic, send_cpu_ram_to_local_redis, send_cpu_ram_to_center_elastic, send_cpu_ram_to_center_redis, get_best_analyzer, check_phan_tai
...
def start():
    sec = int(get_env("ANALYZER_RAM_CPU_SECONDS", "10"))
