      ...
      <Row>
        <Col xs={24}>
          <Card title="Tài nguyên RAM-CPU máy chủ">
            <iframe src="http://localhost:3000/d-solo/bbc3048e-93bf-4708-85c0-6a5ca86ebf7e/cpu-ram?orgId=1&refresh=10s&from=1701970581878&to=1701971181878&panelId=1" width="100%" height="300px" frameborder="0"></iframe>
          </Card>
        </Col>
      </Row>
      <Row>
        <Col xs={24} md={12}>
          <Card>
            ...
            <iframe src="http://localhost:3000/d-solo/e5ee296d-d626-4efd-a969-1d02532b252d/datn?orgId=1&from=1701962758234&to=1701966358234&theme=dark&panelId=2" width="100%" height="300px" frameborder="0"></iframe>
          </Card>
        </Col>
        <Col xs={24} md={12}>
          <Card>
            {/* <DemoLiquid value={dataDashboard?.RAM} title="RAM" /> */}
            <iframe src="http://localhost:3000/d-solo/e5ee296d-d626-4efd-a969-1d02532b252d/datn?orgId=1&from=1701962723935&to=1701966323935&theme=dark&panelId=3" width="100%" height="300px" frameborder="0"></iframe>
          </Card>
        </Col>
      </Row>
    </Spin>
