    ...
    <>
        ...
        {setting.timeBlacklist !== -1 && (
          <Typography className={styles.itemForm}>
            {`
              ...
              ${Math.floor(
                (setting.timeBlacklist - Math.floor(setting.timeBlacklist / 86400) * 86400) / 3600,
              )} giờ
              ${Math.floor(
                (setting.timeBlacklist -
                  Math.floor(setting.timeBlacklist / 86400) * 86400 -
                  Math.floor(
                    (setting.timeBlacklist - Math.floor(setting.timeBlacklist / 86400) * 86400) /
                      3600,
                  ) *
                    3600) /
                  60,
      ...
      <Drawer title="Cập nhập" width={720} onClose={onClose} open={visible}>
        <Form
          ...
          labelCol={{ span: 8 }}
          wrapperCol={{ span: 16 }}
          initialValues={setting.dataAutoBlacklist}
          onFinish={onFinish}
